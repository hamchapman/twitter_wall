 ...
 * angularTest.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://angularTest.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://angularTest.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('angularTest', []).config(function($sceDelegateProvider) {
 ...
 *        'http://angularTest.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="angularTestController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("angularTestController", function angularTestController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('angularTestWithSceDisabledangularTest', []).config(function($sceProvider) {
